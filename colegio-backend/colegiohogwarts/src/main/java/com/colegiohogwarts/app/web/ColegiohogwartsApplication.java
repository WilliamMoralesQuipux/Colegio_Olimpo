...
public class ColegiohogwartsApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
	   ...
	   //Porfesores
		...
		template.update("INSERT INTO CURSOxASIGNATURA (idcurso , idasignatura) VALUES ( 4,  1)");
		template.update("INSERT INTO CURSOxASIGNATURA (idcurso , idasignatura) VALUES ( 4,  5)");
		...
		template.execute("ALTER TABLE COLEGIOxCURSO  ADD FOREIGN KEY (idcolegio) REFERENCES COLEGIO (idcolegio) ");
		template.execute("ALTER TABLE COLEGIOxCURSO  ADD FOREIGN KEY (idcurso) REFERENCES CURSOS (idcurso) ");
		
		template.update("INSERT INTO COLEGIOxCURSO (idcolegio ,idcurso ) VALUES ( 1,  1)");
		template.update("INSERT INTO COLEGIOxCURSO (idcolegio ,idcurso ) VALUES ( 1,  2)");
		template.update("INSERT INTO COLEGIOxCURSO (idcolegio ,idcurso ) VALUES ( 1,  3)");
		template.update("INSERT INTO COLEGIOxCURSO (idcolegio ,idcurso ) VALUES ( 1,  4)");
